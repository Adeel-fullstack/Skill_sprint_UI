<template>
  <footer class="w-full bg-white pt-8 px-4 md:px-8 border-t border-gray-100 pb-14">
    <div class="max-w-7xl mx-auto">
      <!-- Links Section: only 3 columns -->
       <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-8 gap-y-6 mb-4 pl-2 md:pl-6">
        <div 
